...
pr, PatientRegistrationObj, showview, svhandler, viewnotes, searchnotes;  
...
PatientRegistrationObj = function (databasename, remoteorigin) {   
	'use strict';
    
    Object.defineProperty(this, 'pdb', {writable: true});
    Object.defineProperty(this, 'remote', {writable: true});
    Object.defineProperty(this, 'regisFormobject', {writable: true});  
...
PatientRegistrationObj.prototype.buildtime = function(timestamp){
...
PatientRegistrationObj.prototype.builddate = function (timestamp) {
...
PatientRegistrationObj.prototype.reporter = function (error, response) {
    'use strict';
...
PatientRegistrationObj.prototype.showerror = function (error) {
...
PatientRegistrationObj.prototype.show = function (selector) {
    'use strict';
...
PatientRegistrationObj.prototype.hide = function (selector) {
    'use strict';
    var els = document.querySelectorAll(selector);
    Array.prototype.map.call(els, function (el) {
...
PatientRegistrationObj.prototype.resethash = function () {
    window.location.hash = '';   
}

PatientRegistrationObj.prototype.savePatient = function () {
    'use strict';
    var o = {}, that = this;
...
pr = new PatientRegistrationObj('patientregistration');
pr.regisFormobject = document.getElementById('registrationForm');
pr.searchformobject  = document.getElementById('patientSearch');
pr.errordialog  = document.getElementById('errordialog');

pr.searchformobject.addEventListener('submit', function (e) {
   'use strict';
    e.preventDefault();
    pn.search(); 
});

pr.regisFormobject.addEventListener('submit', function (e) {
    e.preventDefault();
    pn.savePatient()
});
